...
| P2-02 | active | INT-00 `01a0c881-9454-7fa3-a276-cb5756debad3`，de32 工作区 | 正审查并集成 P2-01 与初版 P2 文档 |
...
等待 P2-02 新集成 SHA；取得后核对 P2-03/P2-04 的共同基线与文件边界，直接续派。开发期只做必要编译/启动/当前阻断检查，实际完整路径留待最后人工试玩。08:00 停止新增功能，11:00 收束，不得仅因已派发就将 P2 标记完成。
