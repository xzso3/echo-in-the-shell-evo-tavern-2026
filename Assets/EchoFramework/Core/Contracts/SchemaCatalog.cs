...
namespace Echo.Framework.Contracts
{
    ...
    public static class SchemaCatalog
    {
        ...
        public static JObject Int32(int min=0) => new JObject { ["type"]="integer",["minimum"]=min,["maximum"]=int.MaxValue };
        public static JObject PackageId() => Text(@"^(?!.*\.\.)[a-z][a-z0-9_.-]*(?![\s\S])");
        ...
        public static JObject Version() => Text(@"^(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)(?![\s\S])");
        public static JObject Digest() => Text(@"^[a-f0-9]{64}(?![\s\S])");
        public static JObject Id() => Text(ContentId.Pattern);
        public static JObject Path() => Text(@"^(?!/)(?!.*(?:^|/)\.\.(?:/|(?![\s\S])))(?!.*\\)[a-zA-Z0-9_./-]+(?![\s\S])");
        public static JObject Ref(params string[] kind) => Object(("run_id",Text()),("kind",Enum(kind.Length==0?new[]{"run","level","encounter","entity","execution","rule_set","attack","quest","dialogue","map","chunk","projectile","control_lease"}:kind)),("serial",Integer(1)),("generation",Int32(1)));
        ...
        public static IReadOnlyDictionary<string,JObject> Build()
        {
            ...
            result["package"]=Object(("package_id",PackageId()),("package_version",Version()),("schema_version",Enum(ContractVersion.Current)),("required_capabilities",List(Object(("id",Text()),("version",Version())))),("dependencies",List(Object(("package_id",PackageId()),("package_version",Version()),("sha256",Digest())))),("exports",List(Id())),("entrypoints",List(Id())),("resource_manifest",Path()));
            result["resources"]=Object(("schema_version",Enum(ContractVersion.Current)),("resources",List(Object(("id",Text(@"^(?!.*\.\.)(?!.*\/(?![\s\S]))[a-z][a-z0-9_.-]*:resource/[a-z][a-z0-9_./-]*(?![\s\S])")),("type",Enum("sprite","texture","audio","text","font")),("source_path",Path()),("sha256",Digest()),("license",Text())))));
            result["input"]=Input();result["instance_ref"]=Ref();result["typed_value"]=TypedValue();
            result["case"]=Object(("case_id",Text()),("requirement_ids",List(Text(),1)),("package",Object(("package_id",PackageId()),("package_version",Version()),("sha256",Digest()))),("entrypoint",Id()),("seed",Int32()),("timestep",new JObject{["type"]="number",["minimum"]=0.000001,["maximum"]=1}), ("max_ticks",Integer(1)),("setup",Object(("fixture_kind",Enum("unit","integration")),("fixture_id",Text()))),("steps",List(new JObject{["oneOf"]=new JArray(Object(("op",Enum("input")),("intent",Input())),Object(("op",Enum("advance")),("ticks",Integer(1))),Object(("op",Enum("wait_event")),("event_type",Text()),("max_ticks",Integer(1))),Object(("op",Enum("move_to_marker")),("actor",Ref("entity")),("marker",Object(("map",Ref("map")),("chunk",Ref("chunk")),("local_id",Text()))),("max_ticks",Integer(1))))})),("expect",Object(("outcome",Enum("succeeded","failed","cancelled")),("error_codes",List(Text())),("events",List(Object(("type",Text()),("count",Integer())))),("event_order",List(Text())),("remaining_resources",Object(("listeners",Integer()),("actions",Integer()),("control_leases",Integer()),("projectiles",Integer()),("dialogues",Integer()))))),("verification_layer",Enum("static","logic","unity","manual")));
            result["report"]=Object(("report_version",Enum(ContractVersion.Current)),("content_digest",Digest()),("dependency_digests",List(Object(("package_id",PackageId()),("sha256",Digest())))),("framework_version",Version()),("framework_digest",Digest()),("tested_commit",Text()),("catalog_digest",Digest()),("schema_digest",Digest()),("runner_version",Version()),("environment",Object(("host",Text()),("runtime",Text()),("os",Text()))),("seed",Int32()),("cases",List(Object(("case_id",Text()),("status",Enum("passed","failed","not_run","blocked")),("duration_ms",Number()),("expected",Text()),("actual",Text()),("diagnostics",List(Diagnostic())),("artifacts",List(Text()))))));
            ...
            result["module_descriptor"]=Object(("id",Text()),("version",Version()),("order",Int32()),("dependencies",List(Text())),("capabilities",List(result["capability_descriptor"])));
