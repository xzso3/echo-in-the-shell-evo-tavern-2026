...
namespace Echo.NativeGame
{
    ...
    public sealed class NativeHud : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            promptLabel.text = dialogue.HasChoices ? "点击选择 / E 暂不选择" : dialogue.IsOpen ? "E  /  收到" : nearbyBoss || nearbyCombatBoss || legacyCore ? "E  /  解除核心封锁" : nearbyScoped ? nearbyScoped.Prompt : nearby ? nearby.Prompt : level.Running ? "WASD 移动    Space 自动开火/停火    E 互动    Tab 手机" : "";
        }
